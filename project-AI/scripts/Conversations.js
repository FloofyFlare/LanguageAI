export const conversationTopics = [
  ...
  // Streaming
    [{ role: 'user', content: `Help me learn to talk about streaming and digital media with conversation introduction practice. You must respond in ACTFL Novice Low French. Example
      Tutor : Bonjour, comment ça va ?
  ...
  // Professions
    [{ role: 'user', content: `Help me learn to talk about professions, careers & work with conversation conversation practice. You must respond in ACTFL Novice Low French. Example
      ...
      ### feel free to change your professions from the example ###
      ...
    ` },
    { role: 'assistant', content: "Que faites-vous dans la vie ?" }],
  // Food
    [{ role: 'user', content: `Help me learn to talk about streaming and digital media with repetitive introduction practice. You must respond in ACTFL Novice Low French. Example
